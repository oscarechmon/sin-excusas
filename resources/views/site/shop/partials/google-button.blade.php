@if (config('services.google.client_id'))
  {{-- data-turbo="false": Google es otro dominio y Turbo no puede seguir esa redirección. --}}
  <a class="se-btn se-btn--google w-100" href="{{ route('shop.google.redirect') }}" data-turbo="false">
  ...
  <div class="se-divider" role="separator"><span>o con tu correo</span></div>
@endif
